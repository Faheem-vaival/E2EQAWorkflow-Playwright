...
Workflow Overview
This prompt guides you through a complete 7-step QA workflow using MCP servers and Al agents to go from user story to committed automated test scripts.
...
3. Create a comprehensive test plan that covers all acceptance criteria including: Happy path scenarios
...
- Use proper wait strategies based on actual application behavior Add proper test hooks (beforeEach, afterEach)
...
5. Test Coverage Analysis
 ...
 - Coverage from manual vs automated test
...
Git Repository URL: https://github.com/Faheem-vaival/E2EQAWorkflow-Playwright.git
Prompt:
...
STEP 4 GENERATE AUTOMATION SCRIPTS:
Review both the test plan (specs/saucedemo-checkout-test-plan.md) and exploratory testing results from Step 3. Use the playwright-test-generator agent to create JavaScript
automation scripts leveraging the element selectors and insights discovered during manual testing. Save scripts in tests/saucedemo-checkout/.
